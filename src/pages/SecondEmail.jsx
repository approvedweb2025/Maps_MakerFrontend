...
const SecondEmail = () => {
  ...
  const fetchPhotos = async () => {
    try {
      ...
      console.error("❌ Error fetching photos for SecondEmail:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  const openPreview = (photo) => {
    // ✅ TABDEELI KI GAYI HAI: Image URL banane ke logic ko ek function mein daal diya hai
